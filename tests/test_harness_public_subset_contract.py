...
def test_contract_doc_mirrors_registry_and_boundary_language():
    ...
    for text in (
        "Scope and live enforcement",
        "Surface classification",
        "Canonical public version and kinds",
        "Canonical public top-level rules",
        "Public graph primitives",
        "Public transition forms",
        "Public stage families and role-family bindings",
        "Planning-specific canonical requirements",
        "Compatibility-only input",
        "Internal and private preserved surfaces",
        "Example taxonomy",
        "Diagnostics and out-of-scope boundary",
        "StrategyConfig.from_dict()",
        "universal public-boundary enforcement",
        "validator_preflight_node()",
        "parser-owned boundary",
